...
class OctalPermissionsRule(AnsibleLintRule):
    ...
    description = 'Numeric file permissions without leading zero can behave in unexpected ways. See https://docs.ansible.com/ansible/latest/collections/ansible/builtin/replace_module.html for more details'
    tag = 'Formatting'
