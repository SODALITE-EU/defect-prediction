...
class IPTypeRule(AnsibleLintRule):
    ...
    description = 'IP address must be in valid format. See https://docs.ansible.com/ansible/latest/collections/ansible/builtin/wait_for_module.html for more details'
    tag = 'Formatting'
