    ...
    for tup in similar_names:
        ...
        for tup2 in lst:
            ...
            if tup2[0] == rand_id:
                found = True
                acc = tup2[1]
                print('The randomly selected element was found at the ' + str(index) + ' position with accuracy' + str(
                    round(acc, 2)))
...
def mutate_descriptions_old(method, tasks_df):
    """ This method mutates the methods descriptions column.
    It replaces the implementation of the ansible module by randomly selecting another """
